...
public class DirCumSampleMonAgent implements LocationMonitorAgent {
	private MonBuildClose myagent;
	private int nonzerocount = 0;
	private int nummoncon = 0;
	private double relBaseWeight = 0.05;
	
	public DirCumSampleMonAgent() {
		System.out.println("DirCumSample - MonAgentRelative Base Weight:\t"+this.relBaseWeight);
	}
